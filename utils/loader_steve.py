...
def load_all_as_dict_pd(
    ...
    for q in labels['q'].unique():
        if q <= 3:
            dict_all[q] = {'X': dict_dfs['0_4'].iloc[:, 2:], 
                           'y': labels['correct'][labels['q'] == q]}
        elif q <= 13:
            dict_all[q] = {'X': dict_dfs['5_12'].iloc[:, 2:], 
                           'y': labels['correct'][labels['q'] == q]}
        elif q <= 18:
            dict_all[q] = {'X': dict_dfs['13_22'].iloc[:, 2:], 
                           'y': labels['correct'][labels['q'] == q]}
    return dict_all
